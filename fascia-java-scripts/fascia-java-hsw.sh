...
LIBJARS=/N/u/lc37/Project/harp-sahad/target/harp-sahad-1.0-SNAPSHOT.jar:${HOME}/Lib/HJlib/habanero-java-lib-0.1.4-SNAPSHOT.jar:${HADOOP_HOME}/share/hadoop/common/lib/log4j-1.2.17.jar:${HADOOP_HOME}/share/hadoop/common/lib/commons-cli-1.2.jar
